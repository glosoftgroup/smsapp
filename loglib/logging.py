...
class KeyValueRenderer(object):
    ...
    def __call__(self, logger, name, event_dict):
        serialize = lambda v: json.dumps(v, default=_serializer)  # noqa: E731
...
class INSerializer(json.JSONEncoder):
    """
    Adapted from django.hermes_status.serializers.json.DjangoJSONEncoder
    Allows serialising IN results by returning a string of any
